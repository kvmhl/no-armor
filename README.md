...
A lightweight [PaperMC](https://papermc.io/) plugin for Minecraft 1.21.4+ that lets you customize which armor, tools, and inventory slots players can use — with visual feedback showing restricted slots as greyed out.
